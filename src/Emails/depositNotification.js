export const depositNotification = (name, amount, balance) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Questpay Deposit Notification</title>
  <style>
    body {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="container">
    ...
    <!-- Body Content -->
    <div class="content">
      <h2>User Deposit Notification! 💸</h2>
      <p>Hi <span class="username">${name}</span>,</p>

      <p>${name} made a deposit of of <strong>NGN${amount}</strong>.</p>
      <p>User new balance is <strong>NGN${balance}</strong>.</p>
