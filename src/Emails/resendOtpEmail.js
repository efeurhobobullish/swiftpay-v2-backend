...
export const resendOtpEmail = (name, email, code) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Questpay Resend OTP</title>
  <style>
    body {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>You requested for a new OTP for verification code.</p>

      <p>Your OTP for verification is <strong>${code}</strong>.</p>
      <p>Please enter this OTP in the verification page to complete your verification.</p>

      <div class="cta">
        <a href="https://questpay.ng/verify?email=${email}">Proceed to Verification</a>
      </div>
