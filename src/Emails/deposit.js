export const deposit = (name, amount, balance) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Your Questpay wallet has received a credit transaction of <strong>NGN${amount}</strong>.</p>
