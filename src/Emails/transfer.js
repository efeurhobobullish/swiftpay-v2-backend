export const transfer = (name, amount, balance, receiver) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Questpay Wallet Transfer</title>
  <style>
    body {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p>You have successfully transferred <strong>NGN${amount}</strong> to ${receiver}.</p>
      <p>Your new balance is <strong>NGN${balance}</strong>.</p>
