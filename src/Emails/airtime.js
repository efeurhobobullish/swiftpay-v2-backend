export const airtime = (name, amount, balance, phoneNumber, network) => {
  return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <div class="container">
    ...
    <!-- Body Content -->
    <div class="content">
      <h2>Airtime Purchase Alert! 💸</h2>
      <p>Hi <span class="username">${name}</span>,</p>

      <p>You have successfully purchased airtime of <strong>NGN${amount}</strong> for <strong>${phoneNumber}</strong> on <strong>${network}</strong>.</p>
